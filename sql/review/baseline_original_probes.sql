-- RUN 2026-09-23. Completed SELECTs; returned rows per statement: 8, 17, 9, 15, 1, 1, 5, 8.
-- Purpose: reproduce executable probe outputs only; comments are original unverified claims.
-- Claim IDs: R2 S2 S4 S5 S7 S8 S9 S14 S26 RS24 RS30 Q4.
-- Expected: original numeric claims in the inherited comments; record live drift.
